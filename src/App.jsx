...
function App() {
  ...
  if (currentPath === '/cookies') {
    return <CookiesPolicy onNavigate={navigateTo} />;
  }
      ...
      <section id="guide" className="guide-section">
        <div className="guide-container">
          <div className="section-header text-center">
            ...
            <p className="section-subtitle">Understanding the official types, screen sizes, and export standards for Indian coffee bean suppliers.</p>
          </div>
        ...
        <div className="footer-container">
          <div className="footer-cols">
            ...
            <div className="footer-links-col">
              ...
              <a href="/cookies" onClick={(e) => { e.preventDefault(); navigateTo('/cookies'); }}>Cookies</a>
              <a href="/terms" onClick={(e) => { e.preventDefault(); navigateTo('/terms'); }}>Terms and Conditions</a>
            </div>
